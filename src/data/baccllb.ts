...
export const modules: ModuleInfo[] = [
  {
    ...
    icon: Calculator,
    weakPoints: [
      'Chapter 8–11 application under exam pressure',
      'IAS 16 PPE classification and presentation logic',
      'IAS 19 employee benefits',
      'IAS 37 provisions, contingent liabilities and contingent assets',
      'IAS 7 statement of cash flows',
      'IFRS 10 consolidated financial statements',
      'Exam application: why each adjustment is made, not only calculations',
    ],
    examFocus: [
      'Read the scenario twice and highlight trigger words before touching numbers',
      'Classify the standard/adjustment first, then calculate',
      'Show clean workings, journal logic, presentation and disclosure',
      'Use memo-style layouts and explain assumptions briefly',
    ],
    studySystem: [
      'Simple explanation → formal accounting treatment → exam workflow → worked example → trap list',
      'Daily mini drills on classification and presentation',
      'One timed adjustment question after each theory block',
      'Mistake log: topic, error type, corrected rule, retest date',
    ],
    nextActions: [
      'Build Chapter 11 inventory + periodic/perpetual MegaNote',
      'Create Chapter 13 adjustments Final Boss sheet',
      'Do one timed memo-style question and mark it against the answer pack',
    ],
    assessments: [
      { title: 'A1', date: '2026-03-24', time: '17:30', status: 'done', notes: '3h + reading; foundational pressure test' },
      { title: 'A2', date: '2026-05-20', time: '14:00', status: 'upcoming', notes: 'Major application-heavy target assessment' },
    ],
  },
  {
    id: 'econ114',
    ...
    icon: LineChart,
    weakPoints: ['CORE Unit 7', 'CORE Unit 8', 'CORE Unit 9', 'Graph interpretation under MCQ pressure'],
    examFocus: [
      'Unit 7: firm/customer logic and profit maximisation',
      'Unit 8: supply, demand, competitive equilibrium and price-taking firms',
      'Unit 9: market dynamics and welfare reasoning',
      'Graph tracker: axes, shape, movement, exam meaning',
    ],
    studySystem: [
      'Graph-first notes with “what changes, why, and where it moves”',
      'MCQ trap bank and false-statement correction',
      'One topic = one diagram + one paragraph explanation + one MCQ set',
    ],
    nextActions: ['Finish Unit 8 Part B Core Pack', 'Do Unit 7–8 mixed graph drill', 'Make Unit 9 prediction list'],
    assessments: [
      { title: 'A1', date: '2026-04-08', status: 'done' },
      { title: 'A2', date: '2026-05-23', status: 'upcoming' },
    ],
  },
  {
    id: 'foundations178',
    ...
    icon: Landmark,
    weakPoints: ['Roman Legal History / Theme 5 uncertainty', 'Heavy content load', 'Remembering legal development timelines'],
    examFocus: [
      'Timeline → legal development → significance → modern link',
      'Define the legal concept before discussing history',
      'Use compare/contrast tables for traditions and institutions',
    ],
    studySystem: [
      'Theme maps with chronology lanes',
      'One-page Roman law timeline',
      'Teach-aloud recall in 5-minute bursts',
    ],
    nextActions: ['Confirm Theme 5 scope', 'Build Roman Legal History timeline', 'Do one 10-mark historical significance answer'],
    assessments: [
      { title: 'A1', date: '2026-03-19', status: 'done' },
      { title: 'A2', date: '2026-05-27', status: 'upcoming' },
    ],
  },
  {
    id: 'conlaw178',
    code: 'CON178',
    name: 'Introduction to Constitutional Law 178',
    shortName: 'Con Law',
    area: 'Law',
    semester: 'S1',
    target: 80,
    ...
    icon: Gavel,
    weakPoints: ['Theme integration', 'Section 36 limitation structure', 'Horizontal vs vertical application', 'Precedent and constitutional interpretation'],
    examFocus: [
      'Issue → constitutional provision → test → application → conclusion',
      'Always separate limitation and justification',
    ...
    nextActions: ['Finalise Theme 4 tutorial polish', 'Create section 36 proportionality skeleton', 'Do one timed 15-mark answer'],
    assessments: [
      { title: 'A1', date: '2026-04-16', time: '15:00', weight: 15, status: 'done' },
      { title: 'A2', date: '2026-06-08', time: '09:00', status: 'upcoming' },
    ],
  },
  {
    id: 'legalskills114',
    ...
    icon: Scale,
    weakPoints: ['Faculty writing guide precision', 'Footnotes and bibliography accuracy', 'Legal opinion structure', 'ReadTheory completion evidence'],
    examFocus: [
      'Use PEEL / ISAR style depending on question type',
      'Footnotes must be accurate and not dumped at paragraph ends only',
      'Preserve formal legal tone and authority hierarchy',
      'ReadTheory: Lexile ≥1450L and ≥70% quiz score target',
    ],
    studySystem: [
    ...
    nextActions: ['Build A2 all-star answer template DOCX', 'Run footnote audit on latest tutorial', 'Update ReadTheory progress evidence'],
    assessments: [
      { title: 'A2 / Legal Writing task', date: '2026-04-20', status: 'done' },
      { title: 'ReadTheory evidence', date: '2026-05-15', status: 'upcoming', notes: 'Track placement, first quiz and passing quiz screenshots' },
    ],
  },
  {
    id: 'sds188',
    code: 'SDS188',
    name: 'Statistics & Data Science 188',
    shortName: 'Stats 188',
    area: 'Quantitative',
    semester: 'S1',
    target: 80,
    ...
    icon: BarChart3,
    weakPoints: ['Chapters 3–6', 'Chapters 1–2 possible foundation testing', 'Variable identification', 'Formula selection under time pressure'],
    examFocus: [
      'Identify variable type before choosing method',
      'Write down givens and required output',
      'Use calculator workflow checklist',
      'Explain meaning of result in plain English',
    ],
    studySystem: [
      'Dashboard/playbook style revision',
      'Formula → trigger phrase → worked example → interpretation',
      'Panic-proof “follow this order” checklist',
    ],
    nextActions: ['Map Chapters 3–6 into topics', 'Create formula trigger table', 'Do one mixed interpretation drill'],
    assessments: [
      { title: 'A1', date: '2026-04-23', status: 'done' },
      { title: 'A2', date: '2026-06-01', time: '09:00', status: 'upcoming' },
    ],
  },
  {
    id: 'dla112122',
    code: 'DLA112/122',
    name: 'Digital & Leadership Acumen 112/122',
    shortName: 'DLA',
    area: 'Digital',
    semester: 'Year',
    target: 80,
    ...
    icon: Laptop,
    weakPoints: ['Project instructions', 'Evidence handling', 'Spreadsheet final checking', 'Explaining what was done and why'],
    examFocus: [
      'Only use visible/official evidence',
      'Explain spreadsheet logic step by step',
      'Document assumptions and limitations',
      'Check formulas, locking and final file requirements',
    ],
    studySystem: [
      'Project overview → evidence list → workbook steps → final audit',
      'Screenshot/evidence checklist',
      'Claude/Codex prompt refinement layer',
    ],
    nextActions: ['Final check DLA 122 A2 file', 'Write step-by-step project walkthrough', 'Lock and test spreadsheet formulas'],
    assessments: [
      { title: 'A2 submission', date: '2026-05-15', time: '16:00', status: 'upcoming' },
    ],
  },
  {
    id: 'lawpersons144',
    ...
    examFocus: ['Start with status, capacity, personality rights and remedies once module opens', 'Build case cards from week 1'],
  ...
  },
  {
    ...
    examFocus: ['Keep definitions, legal systems and sources of law cleanly separated'],
...
export const taskTemplates: TaskTemplate[] = [
  ...
  { id: 'dla-final', title: 'DLA: final workbook formula + instruction audit', moduleId: 'dla112122', type: 'Submission', priority: 'Critical', points: 16, minutes: 60, why: 'Project instructions and spreadsheet final checking are high risk.' },
